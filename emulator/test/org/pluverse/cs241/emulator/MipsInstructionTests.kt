...
import org.pluverse.cs241.emulator.cpumodel.LisInstruction
...
import org.pluverse.cs241.emulator.cpumodel.WrongMipsInstructionException
...
class MipsInstructionTests {
  ...
  fun testAddInstructionReadsOnlyAddInstruction() {
    ...
    assertThrows(WrongMipsInstructionException::class.java) {
      AddInstruction(modifiedAddOperandErrorInstr)
    }

    val modifiedAddOpcodeErrorInstr = 0xf0000000.toInt() or ADD
    assertThrows(WrongMipsInstructionException::class.java) {
      AddInstruction(modifiedAddOpcodeErrorInstr)
    }
  ...
  fun testSubInstructionReadsOnlySubInstruction() {
    ...
    assertThrows(WrongMipsInstructionException::class.java) {
      SubInstruction(modifiedSubOperandErrorInstr)
    }

    val modifiedSubOpcodeErrorInstr = 0xf0000000.toInt() or SUB
    assertThrows(WrongMipsInstructionException::class.java) {
      SubInstruction(modifiedSubOpcodeErrorInstr)
    }
  ...
  fun testSetLessThanInstructionReadsOnlySetLessThanInstruction() {
    ...
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { SetLessThanInstruction(LW.toInt()) }
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { SetLessThanInstruction(SW.toInt()) }
  ...
  fun testSetLessThanUInstructionReadsOnlySetLessThanUInstruction() {
    ...
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { SetLessThanUInstruction(LW.toInt()) }
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { SetLessThanUInstruction(SW.toInt()) }
  ...
  fun testJumpAndLinkInstructionReadsOnlyJumpAndLinkInstruction() {
    ...
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { JumpAndLinkInstruction(LW.toInt()) }
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { JumpAndLinkInstruction(SW.toInt()) }
  ...
  fun testLoadInstructionRegisterUpdates() {
    ...
    run {
      val lwInstruction =
        LoadWordInstruction(modifyInstr(LW.toInt(), imm = 2.0.pow(15.0).toInt() - 1))
  ...
  fun testSaveInstructionRegisterUpdates() {
    ...
    run {
      val swInstruction =
        StoreWordInstruction(modifyInstr(SW.toInt(), imm = 2.0.pow(15.0).toInt() - 1))
  ...
  fun testBranchEqualInstructionReadsOnlyBranchEqualInstruction() {
    ...
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { BranchEqualInstruction(LW.toInt()) }
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { BranchEqualInstruction(SW.toInt()) }
  ...
  fun testBranchNotEqualInstructionReadsOnlyBranchNotEqualInstruction() {
    ...
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { BranchNotEqualInstruction(LW.toInt()) }
    assertThrows(
      WrongMipsInstructionException::class.java,
    ) { BranchNotEqualInstruction(SW.toInt()) }
