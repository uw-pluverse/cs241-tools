...
class MipsInstructionExecuteTests {
  ...
  fun addInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      // Separate registers
      val addInstruction =
        AddInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.ADD, 3, 2, 1))
      registers[1] = 5
      registers[2] = 10
      registers[3] = 15
      addInstruction.execute(
    ...
    run {
      ...
      val addInstruction =
        AddInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.ADD, 3, 2, 3))
      registers[2] = 10
      registers[3] = 5
      addInstruction.execute(
        context,
  ...
  fun subInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      // Separate registers
      val subInstruction =
        SubInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.SUB, 3, 2, 1))
      registers[1] = 5
      registers[2] = 10
      registers[3] = 15
      subInstruction.execute(
    ...
    run {
      ...
      val subInstruction =
        SubInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.SUB, 3, 2, 3))
      registers[2] = 10
      registers[3] = 5
      subInstruction.execute(
        context,
  ...
  fun multiplyInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      ...
      val multiplyInstruction =
        MultiplyInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.MULT, 2, 1))
      registers[2] = 25
      registers[1] = 5
      multiplyInstruction.execute(
        context,
  ...
  fun divideInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      ...
      val divideInstruction =
        DivideInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.DIV, 2, 1))
      registers[2] = 125
      registers[1] = 5
  ...
  fun divideUInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      // Test divide 2 positives
      val divideInstruction =
        DivideUInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.DIVU, 2, 1))
      registers[2] = 125
      registers[1] = 5
      divideInstruction.execute(
        context,
  ...
  fun jumpInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      // Test jump to 12
      val jumpInstruction =
        JumpInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.JR, 1))
      pc = Address()
      registers[1] = 12
      jumpInstruction.execute(
        context,
  ...
  fun jumpAndLinkInstructionUpdatesRegisterCorrectly() {
    ...
    run {
      // Test jump to 12
      val jumpInstruction =
        JumpAndLinkInstruction(MipsInstructionTests.modifyInstr(MipsInstructionTests.JALR, 1))
      pc = Address(24u)
      registers[1] = 12
      jumpInstruction.execute(
        context,
